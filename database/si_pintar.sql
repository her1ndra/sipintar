...
--
-- Host: localhost
-- Waktu pembuatan: 24 Sep 2026 pada 02.24
...
INSERT INTO `diklat` (`id_diklat`, `id_kompetensi`, `nama_diklat`, `penyelenggara`, `deskripsi`, `created_at`) VALUES
(1, NULL, 'Diklat Administrasi Perkara Perdata', NULL, NULL, '2026-09-24 02:06:28'),
(2, NULL, 'Pelatihan SIPP dan e-Berpadu', NULL, NULL, '2026-09-24 02:06:28'),
(3, NULL, 'Diklat Administrasi Perkara Tipikor', NULL, NULL, '2026-09-24 02:06:28'),
(4, NULL, 'Pelatihan Teknis Perkara PHI', NULL, NULL, '2026-09-24 02:06:28'),
(5, NULL, 'Pelatihan Dokumentasi dan Pelaporan', NULL, NULL, '2026-09-24 02:06:28'),
(6, NULL, 'Diklat Administrasi Kepegawaian', NULL, NULL, '2026-09-24 02:06:28'),
(7, NULL, 'Pelatihan Monitoring Evaluasi dan TI', NULL, NULL, '2026-09-24 02:06:28'),
(8, NULL, 'Diklat Pengelolaan BMN dan Keuangan', NULL, NULL, '2026-09-24 02:06:28'),
(9, NULL, 'Pelatihan Service Excellent, Pelatihan PTSP', NULL, NULL, '2026-09-24 02:06:28');
...
CREATE TABLE `kebutuhan_diklat` (
  ...
  `diklat_lainnya` varchar(200) DEFAULT NULL,
...
INSERT INTO `kebutuhan_diklat` (`id_kebutuhan`, `id_pegawai`, `id_kesenjangan`, `id_diklat`, `diklat_lainnya`, `metode_pengembangan`, `prioritas`, `status`, `tahun_rencana`, `catatan`, `created_at`, `updated_at`) VALUES
(1, 58, NULL, NULL, NULL, 'Diklat teknis kepaniteraan', 'Tinggi', 'Diusulkan', '2026', 'Jabatan: Panitera Muda Perdata | Gap: Perlu peningkatan administrasi perkara dan ketelitian kerja | Diklat: Diklat Administrasi Perkara Perdata', '2026-09-22 04:41:56', '2026-09-22 04:41:56'),
(2, 58, NULL, NULL, NULL, 'Diklat teknis kepaniteraan', 'Tinggi', 'Diusulkan', '2026', 'Jabatan: Panitera Muda Pidana | Gap: Perlu pemahaman aplikasi pidana | Diklat: Pelatihan SIPP dan e-Berpadu', '2026-09-22 04:41:56', '2026-09-22 04:41:56'),
(3, 58, NULL, NULL, NULL, 'Diklat teknis kepaniteraan', 'Tinggi', 'Diusulkan', '2026', 'Jabatan: Panitera Muda Tipikor | Gap: Perlu peningkatan administrasi perkara dan ketelitian kerja | Diklat: Diklat Administrasi Perkara Tipikor', '2026-09-22 04:41:56', '2026-09-22 04:41:56'),
(4, 58, NULL, NULL, NULL, 'Diklat teknis kepaniteraan', 'Sedang', 'Diusulkan', '2026', 'Jabatan: Panitera Muda PHI | Gap: Perlu peningkatan administrasi perkara PHI dan ketelitian kerja | Diklat: Pelatihan Teknis Perkara PHI', '2026-09-22 04:41:56', '2026-09-22 04:41:56'),
(5, 58, NULL, NULL, NULL, 'Diklat teknis kepaniteraan', 'Sedang', 'Diusulkan', '2026', 'Jabatan: Panitera Muda Hukum | Gap: Perlu arsiparis perkara | Diklat: Pelatihan Dokumentasi dan Pelaporan', '2026-09-22 04:41:56', '2026-09-22 04:41:56'),
(6, 67, NULL, NULL, NULL, 'Diklat + coaching', 'Tinggi', 'Diusulkan', '2026', 'Jabatan: Kasubbag Kepegawaian | Gap: Administrasi ASN, Penguasaan Aplikasi SIKEP, SI ASN, KOMDANAS, E KINERJA | Diklat: Diklat Administrasi Kepegawaian', '2026-09-22 04:41:56', '2026-09-22 04:41:56'),
(7, 67, NULL, NULL, NULL, 'Bimtek Kepegawaian', 'Sedang', 'Diusulkan', '2026', 'Jabatan: Kasubbag PTIP | Gap: Monitoring Perencanaan, TI dan Pelaporan | Diklat: Pelatihan Monitoring Evaluasi dan TI', '2026-09-22 04:41:56', '2026-09-22 04:41:56'),
(8, 67, NULL, NULL, NULL, 'Bimtek Kepegawaian', 'Tinggi', 'Diusulkan', '2026', 'Jabatan: Kasubbag Umum dan Keuangan | Gap: Perlu penambahan personil dan pelatihan untuk Aplikasi di Keuangan | Diklat: Diklat Pengelolaan BMN dan Keuangan', '2026-09-22 04:41:56', '2026-09-22 04:41:56'),
(9, 70, 10, NULL, NULL, 'In House Training', 'Tinggi', 'Diusulkan', '2026', 'Jabatan: Petugas PTSP | Gap: Perlu service excellent dan pengaduan publik | Diklat: Pelatihan Service Excellent, Pelatihan PTSP', '2026-09-22 04:41:56', '2026-09-22 06:22:38');
...
(1, NULL, '12323', '$2y$10$9NtGq3urEkM56R8LK/6Uq.JfEwCHCSWYwJwVc5IAMlyagwxXJ7nPa', 'Admin', 1, '2026-09-24 08:38:15', '2026-09-13 13:20:29'),
...
(4, 2, '196804141996031002', '$2y$10$Sqlz49AhHXPXvGi4fnj0X.wpyEIa9YDhWHcn0NAmkJXD2Dnb6hkF6', 'Penilai', 1, '2026-09-24 08:36:28', '2026-09-17 01:20:29'),
...
--
ALTER TABLE `diklat`
  MODIFY `id_diklat` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `kebutuhan_diklat`
  MODIFY `id_kebutuhan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
