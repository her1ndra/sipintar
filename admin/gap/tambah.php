...
<form method="post" class="bg-white p-4 rounded shadow-sm" style="max-width:800px;">
  ...
  <div class="mb-3"><label class="form-label" for="kompetensi_jabatan">Kompetensi jabatan</label><textarea name="kompetensi_jabatan" id="kompetensi_jabatan" class="form-control" rows="3" required><?= htmlspecialchars($_POST['kompetensi_jabatan'] ?? '') ?></textarea></div>
  <div class="mb-3"><label class="form-label" for="kompetensi_pegawai_saat_ini">Kompetensi pegawai saat ini</label><textarea name="kompetensi_pegawai_saat_ini" id="kompetensi_pegawai_saat_ini" class="form-control" rows="3" required><?= htmlspecialchars($_POST['kompetensi_pegawai_saat_ini'] ?? '') ?></textarea></div>
  <div class="mb-3"><label class="form-label" for="gap_kompetensi">Gap kompetensi</label><textarea name="gap_kompetensi" id="gap_kompetensi" class="form-control" rows="3" required><?= htmlspecialchars($_POST['gap_kompetensi'] ?? '') ?></textarea></div>
  <div class="mb-3"><label class="form-label" for="dampak">Dampak</label><textarea name="dampak" id="dampak" class="form-control" rows="3" required><?= htmlspecialchars($_POST['dampak'] ?? '') ?></textarea></div>
