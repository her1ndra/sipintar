...
<div class="table-responsive">
    <table class="table table-bordered table-hover bg-white align-middle kuesioner-table">
        <thead>
            <tr>
                <th class="text-center col-no">No</th><th class="col-nama">Nama pegawai</th><th class="col-kompetensi">Kompetensi Jabatan</th><th class="col-pertanyaan">Daftar pertanyaan</th><th class="col-bukti">Bukti kompetensi</th><th class="col-status">Status</th><th class="col-aksi">Aksi</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="action-cell">
                    <div class="dropdown mb-1">
                        <button type="button" class="btn btn-sm btn-outline-secondary dropdown-toggle" data-toggle="dropdown" title="Download pertanyaan" aria-label="Download pertanyaan"><i class="fas fa-download"></i></button>
